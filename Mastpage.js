...
import './App.css';
import { useNavigate } from "react-router-dom"; // connect master page and results page
    ...
    return(
      <ThemeProvider theme={theme1}> {/* ThemeProvider uses the theme function above*/}
        <div>
            ...
            <button onClick={()=>{navigate("/Results");}}>Enter</button> {/*button to link master and results page*/}
            </Typography>
        </div>
      </ThemeProvider>
    )
